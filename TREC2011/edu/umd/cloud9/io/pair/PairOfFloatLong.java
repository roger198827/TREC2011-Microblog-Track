 ...
 * @author Jimmy Lin
 */
public class PairOfFloatLong implements WritableComparable<PairOfFloatLong> {
	 ...
	 */
	public PairOfFloatLong(float left, long right) {
		set(left, right);
	}
	 ...
	 * @param right the right element
	 */
	public void set(float left, long right) {
		leftElement = left;
		rightElement = right;
	}
	...
	public boolean equals(Object obj) {
		PairOfFloatLong pair = (PairOfFloatLong) obj;
	 ...
	 *         <code>obj</code>.
	 */
	public int compareTo(PairOfFloatLong pair) {
	 ...
	 */
	public PairOfFloatLong clone() {
		return new PairOfFloatLong(this.leftElement, this.rightElement);
	}
	...
	static { // register this comparator
		WritableComparator.define(PairOfFloatLong.class, new Comparator());
	}
}
